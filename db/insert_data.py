...
def insert_data(session: Session):
    ...
    session.add_all([drinks, food, home, for_kids_and_babies, toys_and_games, diy_crafts, stationery_and_party_supplies,
    ...
    cartoes_aniversario = Product(id=str(uuid4()), name="Cartões para Festa",
                                ...
                                number_views=7, categories=[stationery_and_party_supplies, diy_crafts], user_id = user1.id)
